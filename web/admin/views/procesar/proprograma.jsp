<%-- 
    Document   : proprograma
    Created on : 25/09/2017, 04:21:21 PM
    Author     : personal
--%>
...
<%
    ...
    boolean exito = fachada.registrarPrograma(nombre,tipo,director, correo, ubicacion, 
            telefono,snies,modalidad, horario, url_imagen, url);

    String resp = "";
    if (exito) {
        resp = "S";
        response.sendRedirect("../RegistrarPrograma.jsp");
    } else {
        resp = "N";
    }
%>

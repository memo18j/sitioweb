<%-- 
    Document   : procesarGrad
    Created on : 26/11/2017, 08:20:39 PM
    Author     : Memo
--%>
...
<%
    ...
    if (!uploaded.isFormField()) {
            ...
            url_imagen = "../../temp/graduados/" + uploaded.getName();
    ...
    boolean exito = fachada.registrarGraduado(tipo, descripcion, nombre, url, url_imagen);
    String resp = "";
    if (exito) {
        resp = "S";

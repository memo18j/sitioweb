<%-- 
    Document   : ModificarGraduados
    Created on : 26/11/2017, 05:04:31 PM
    Author     : Memo
--%>
...
<div class="panel-body">
    <div class="row">
        <section class="panel panel-default">
            <form name="forminter" id="forminter" action="Edit/editGraduados.jsp" enctype="multipart/form-data" method="post" >
                <header class="panel-heading" style="background-color: #aa1916;">
                    <center><span class="h4" style="color: white;"><b>Actualizar Informacion Graduados</b></span></center>
                </header>
                <section class="panel panel-default">
                    <div class="col-md-12">
                        <div class="panel-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" id="id" name="id" value="<%=i.getIdGraduado()%>">
                            </div>    
                            <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control" id="tipo" name="tipo">
                                    <option value="<%=i.getTipoInfog()%>"><%=i.getTnombre()%></option>            
                                    <%
                                       
                                        ArrayList<TipoInfoGraduadoDTO> tg = f.mostrarTipoInfoGrad();
                                        for (TipoInfoGraduadoDTO m : tg) {
                                    %>

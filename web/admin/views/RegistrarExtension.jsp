<%-- 
    Document   : RegistrarExtension
    Created on : 14/11/2017, 02:13:50 PM
    Author     : Memo
--%>
...
<div class="panel-body">
    <div class="row">
        <section class="panel panel-default">
            <form name="formext" id="formext" action="procesar/procesarExtension.jsp" enctype="multipart/form-data" method="post" >
                <header class="panel-heading" style="background-color: #aa1916;">
                    <center><span class="h4" style="color: white;"><b>Registro Informacion de Extension</b></span></center>
                </header>
                <section class="panel panel-default">
                    <div class="col-md-12">
                        <div class="panel-body">
            ...
            <section class="panel">
                <br><br>
                <form name="formtipo" id="formtipo" action="procesar/protext.jsp" method="post">
                    <header class="panel-heading">
                        <center><span class="h4" style="color:"><b>Registrar Nuevo Tipo de Extension</b></span></center>
                    </header>
                    <section class="panel panel-default">
                        <div class="col-md-12">
                            <div class="panel-body">

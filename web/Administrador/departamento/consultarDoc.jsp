<%-- 
    ...
    Created on : 13/06/2017, 07:32:44 PM
    Author     : HP
--%>
...
<div class="container">
    ...
    <div class="container content profile">
        <div class="row">
            ...
            <div>
                <form action="moddocente.jsp" method="post">
                    <div class="col-md-3"></div>
                    <div class="col-md-6">
                        <div class="headline margin-bottom-30"><h4>Docentes</h4></div>
                        <div>
                            <select class="form-control" id="cod_doc" name="cod_doc">
                                <option value="" disabled selected>Elige una opcion</option>           
                                <%
                                    IControlador f = (IControlador) session.getAttribute("fachada");
                                    ArrayList<DocenteDTO> ss = f.mostrarDocente();
                                    for (DocenteDTO m : ss) {
                                %>
                                <option value="<%=m.getCoddocente()%>"> <%=m.getNombre()%> </option>
                                <%
                                    }
                                %>   
                            </select>                

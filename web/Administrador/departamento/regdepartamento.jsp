<%-- 
    ...
    Created on : 4/05/2017, 08:35:35 AM
    Author     : HP
--%>
...
<div class="container">
            ...
            <div class="row">
                <div class="col-md-10" >
                    <h1 class="pull-left" style="font-size: 36px;">
                        <b>Registrar Informacion de departamentos</b></h1>
                </div>
                <div class="col-md-2">
    ...
    <div class="container content profile">
        <div class="row">
            ...
            <div>
                <form id="regd" action="procesar/registrard.jsp"  method="post">
                    <div class="col-md-3"></div>
                    <div class="col-md-6">
                    
                    <div >
                        <div class="headline margin-bottom-30"><h4>Codigo Departamamento</h4></div>
                        <input type="text" class="form-control" id="cod_dep" name="cod_dep" placeholder="codigo departamento">
                    </div>
                    <div>

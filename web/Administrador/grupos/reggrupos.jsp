<%-- 
    Document   : reggrupos
    Created on : 1/06/2017, 07:10:40 PM
    Author     : HP
--%>
...
<div class="container">
            ...
            <div class="row">
                <div class="col-md-10" >
                    <h1 class="pull-left" style="font-size: 36px;">
                        <b>Registrar Informacion Grupos de Investigacion</b></h1>
                </div>
                <div class="col-md-2">
    ...
    <div class="container content profile">
        <div class="row">
            ...
            <div>
                <form id="formg" action="procesar/registrarg.jsp" method="post">
                    <div class="col-md-3"></div>
                    <div class="col-md-6">
                        <div>
                            <div class="headline margin-bottom-30"><h4>Codigo</h4></div>
                            <input type="text" class="form-control" id="cod_gru" name="cod_gru" placeholder="codigo grupo">
                        </div>
                        <div>
                            <div class="headline margin-bottom-30"><h4>Nombre Grupo Investigacion</h4></div>
                            <input type="text" class="form-control" id="nom_gru" name="nom_gru" placeholder="nombre grupo investigacion">
                        </div>
                        <div>

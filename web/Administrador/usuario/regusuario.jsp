<%-- 
    Document   : regusuario
    Created on : 1/06/2017, 07:17:29 AM
    Author     : HP
--%>
...
<div class="container">
            ...
            <div class="row">
                <div class="col-md-10" >
                    <h1 class="pull-left" style="font-size: 36px;">
                        <b>Registrar Informacion de Usuarios</b></h1>
                </div>
                <div class="col-md-2">
    ...
    <div class="container content profile">
        <div class="row">
            ...
            <div>
                <form action="procesar/registraru.jsp" method="post">
                    <div class="col-md-3"></div>
                    <div class="col-md-6">
                    
                    <div >
                        <div class="headline margin-bottom-30"><h4>Codigo Usuario </h4></div>
                        <input type="text" class="form-control" id="cod" name="cod" placeholder="Codigo usuario">
                    </div>
                    <div>
                        <div class="headline margin-bottom-30"><h4>Nombre Usuario </h4></div>
                        <input type="text" class="form-control" id="nom" name="nom" placeholder="Nombre usuario">
                    </div>
                    
                    <div >
                        <div class="headline margin-bottom-30"><h4>Contraseña </h4></div>
                        <input type="text" class="form-control" id="contrasena" name="contrasena" placeholder="Digite contraseña">
                    </div>
                    <div>
                        <div class="headline margin-bottom-30"><h4>Email </h4></div>
                        <input type="email" class="form-control" id="correo" name="correo" placeholder="Digite correo">
                    </div>
                    <div>
                        <div class="headline margin-bottom-30"><h4>Telefono </h4></div>
                        <input type="text" class="form-control" id="tel" name="tel" placeholder="Digite Telefono">
                    </div>
                        <hr>
                    <div>
                        <div class="col-md-3">

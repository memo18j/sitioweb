<%-- 
    ...
    Created on : 12/06/2017, 09:10:49 PM
    Author     : HP
--%>
...
<div class="container">
            ...
            <div class="row">
                <div class="col-md-10" >
                    <h1 class="pull-left" style="font-size: 36px;">
                        <b>Registrar Informacion Proyectos de Investigacion</b></h1>
                </div>
                <div class="col-md-2">
    ...
    <div class="container content profile">
        <div class="row">
            ...
            <div>
                <form id="formse" action="procesar/registrarpy.jsp" method="post">
                    <div class="col-md-3"></div>
                    <div class="col-md-6">
                        <div>
                            <div class="headline margin-bottom-30"><h4>Codigo</h4></div>
                            <input type="text" class="form-control" id="cod_p" name="cod_p" placeholder="codigo proyecto">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" class="form-control" id="nom_p" name="nom_p" placeholder="nombre  del proyecto ">
                        </div>
                        <div>

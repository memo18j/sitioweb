<%-- 
    Document   : modifcarC
    Created on : 15/06/2017, 06:42:58 AM
    Author     : HP
--%>
...
<%
    ...
    for (Object item : items) {
        ...
        if (!uploaded.isFormField()) {
            ...
            out.println(valor);
            if (key.equals("cod_fac")) {
                codigo = Integer.parseInt(valor);
            }
            if (key.equals("concejo")) {
                descripcion = valor;
            }
    ...
    boolean exito = fachada.actualizarDatosConsejo(codigo, descripcion, url_imagen);

    String resp = "";
    if (exito) {
       resp = "S";
        response.sendRedirect("../../principal/facuInge.jsp");
    } else {
         response.sendRedirect("../actconcejo.jsp");
    }
%>
<%= resp%>

<%-- 
    Document   : tecnoobras
    Created on : 4/05/2017, 08:51:58 AM
    Author     : HP
--%>
            ...
            <div class="row">
                <div class="col-md-8">
                    <ul class="breadcrumb no-padding margin-bottom-10">
                        ...
                        <li class="active" title="Información Institucional"  style="font-style: italic; font-size: 14px;">Tecnología en Obras Civiles</li>
                    </ul> 
                </div>
                <div class="col-md-4">
        ...
        <div class="row">
            ...
            <div class="col-md-8 mb-margin-bottom-30">
                ...
                <div class="margin-bottom-40">
                    ...
                    <div class="headline margin-bottom-30"><h1> Tecnología en Obras Civiles</h1></div>
                    <%
                        IControlador fachada = (IControlador) session.getAttribute("fachada");
                        ArrayList<ProgramaDTO> dp = fachada.mostrarPrograma("Tecnologia en obras civiles");

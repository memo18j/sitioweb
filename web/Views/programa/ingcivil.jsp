<%-- 
    Document   : ingcivil
    Created on : 4/05/2017, 08:49:12 AM
    Author     : HP
--%>
            ...
            <div class="row">
                <div class="col-md-8">
                    <ul class="breadcrumb no-padding margin-bottom-10">
                        ...
                        <li class="active" title="Información Institucional"  style="font-style: italic; font-size: 14px;">Ingenieria Civil</li>
                    </ul> 
                </div>
                <div class="col-md-4">
            ...
            <div class="col-md-8 mb-margin-bottom-30">
                <div class="margin-bottom-40">
                    <%
                        ...
                        ArrayList<ProgramaDTO> dp = fachada.mostrarPrograma("Ingenieria civil");
                        for (ProgramaDTO p : dp) {
                            
                            
                              
                    %>
                    <div class="headline margin-bottom-30"><h1>Ingeniera Civil</h1></div>
                    <!--=== carousel ===-->

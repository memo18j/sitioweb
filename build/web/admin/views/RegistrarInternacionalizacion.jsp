<%-- 
    Document   : RegistrarInternacionalizacion
    Created on : 14/11/2017, 02:14:24 PM
    Author     : Memo
--%>
...
<div class="panel-body">
    <div class="row">
        <section class="panel panel-default">
            <form name="forminter" id="forminter" action="procesar/procesarInter.jsp" enctype="multipart/form-data" method="post" >
                <header class="panel-heading" style="background-color: #aa1916;">
                    <center><span class="h4" style="color: white;"><b>Registro Informacion de Internacionalizacion</b></span></center>
                </header>
                <section class="panel panel-default">
                    <div class="col-md-12">
                        <div class="panel-body">
            ...
            <section class="panel">
                <br><br>
                <form name="formtipo" id="formtipo" action="procesar/protinter.jsp" method="post">
                    <header class="panel-heading">
                        <center><span class="h4" style="color:"><b>Registrar Nuevo Tipo de Internacionlizacion</b></span></center>
                    </header>
                    <section class="panel panel-default">
                        <div class="col-md-12">
                            <div class="panel-body">

<%-- 
    Document   : EditNovedad
    Created on : 7/11/2017, 04:05:18 PM
    Author     : Memo
--%>
...
<%
    ...
    boolean exito = fachada.actualizarNovedadDTO(codigo, nombre, url_imagen, descripcion, fecha, tipo);
    String resp = "";
    if (exito) {
        resp = "S";
        response.sendRedirect("../ConsultarNovedad.jsp");
    } else {
        resp = "N";
    }
%>

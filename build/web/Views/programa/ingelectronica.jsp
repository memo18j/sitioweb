            ...
            <div class="row">
                <div class="col-md-8">
                    <ul class="breadcrumb no-padding margin-bottom-10">
                        ...
                        <li class="active" title="Información Institucional"  style="font-style: italic; font-size: 14px;">Ingenieria Electronica</li>
                    </ul> 
                </div>
                <div class="col-md-4">
            ...
            <div class="col-md-8 mb-margin-bottom-30">
                <div class="margin-bottom-40">
                    <%
                        ...
                        ArrayList<ProgramaDTO> dp = fachada.mostrarPrograma("Ingenieria electronica");
                        for (ProgramaDTO p : dp) {
                            
                            
                              
                    %>
                    <div class="headline margin-bottom-30"><h1>Ingeniera Electronica</h1></div>
                    <!--=== carousel ===-->

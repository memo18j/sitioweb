<%-- 
    Document   : verlaboratorios
    Created on : 1/09/2017, 01:38:02 PM
    Author     : personal
--%>
            ...
            <div class="row">
                <div class="col-md-8">
                    <ul class="breadcrumb no-padding margin-bottom-10">
                        ...
                        <li class="active" title="Laboratorios de Investigacion"  style="font-style: italic; font-size: 14px;">Laboratorios de Investigacion</li>
                    </ul> 
                </div>
                <div class="col-md-4">
        ...
        <div class="row">
            ...
            <div class="col-md-8 mb-margin-bottom-30">
                ...
                <div class="margin-bottom-40">
                    ...
                    <div class="headline margin-bottom-30"><h1>LABORATORIOS DE INVESTIGACION</h1></div>
                    <div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-8">
                                                <h5><b>Laboratorio:</b> CARMEN LEONOR BARAJAS FORERO</h5>
                                                <h6> </h6>
                                                <h5><b>Descripcion:</b>Contamos con infraestructura en laboratorios y talleres, 
                                                    cuya dotación en equipos de última tecnología permite la complementación 
                                                    de la enseñanza teórica y a su vez es parte fundamental para los procesos 
                                                    de investigación que se desarrollan a nivel de tesis de pregrado y posgrado.</h5>
                                            </div>
                                            <div class="col-md-4">
                                                <h5><img id="zoom_01" width="200" height="200" src="../imagenes/sal3.jpg" data-zoom-image=""/></h5>    
                                            </div>
                                        </div>
                                    </div>
                                </div>

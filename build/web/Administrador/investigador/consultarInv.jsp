<%-- 
    Document   : consultarInv
    Created on : 14/06/2017, 01:23:55 PM
    Author     : HP
--%>
...
<div class="container">
            ...
            <div class="row">
                <div class="col-md-8">
                    <ul class="breadcrumb no-padding margin-bottom-10">
                        ...
                        <li class="active" title="Información departamentos"  style="font-style: italic; font-size: 14px;">Informacion Investigadores</li>
                    </ul> 
                </div>
                <div class="col-md-4">
    ...
    <div class="container content profile">
        <div class="row">
            ...
            <div>
                <form action="actinvestigador.jsp" method="post">
                    <div class="col-md-3"></div>
                    <div class="col-md-6">
                        <div class="headline margin-bottom-30"><h4>Investigador</h4></div>
                        <div>
                            <select class="form-control" id="cod_inv" name="cod_inv">
                                <option value="" disabled selected>Elige una opcion</option>           
                                <%
                                    IControlador f = (IControlador) session.getAttribute("fachada");
                                    ArrayList<InvestigadorDTO> ss = f.mostrarInvestigador();

<%-- 
    Document   : registrarev
    Created on : 7/06/2017, 07:44:17 AM
    Author     : HP
--%>
...
<%
    ...
    boolean exito = fachada.registrarNovedad(codigo, titulo, url_imagen, descripcion, fecha);

    String resp = "";
    if (exito) {
        resp = "S";
        response.sendRedirect("../regeventos.jsp");
    } else {
        resp = "N";
    }
%>

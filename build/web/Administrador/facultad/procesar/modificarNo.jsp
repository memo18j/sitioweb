<%-- 
    Document   : modificarNo
    Created on : 15/06/2017, 01:58:21 PM
    Author     : HP
--%>
...
<%
    ...
    System.out.println("--" + codigo + "--" + "-" + url_imagen + "-"+ descripcion);
    boolean exito = fachada.actualizarDatosNoticia(codigo, titulo,url_imagen, descripcion);

    String resp = "";
    if (exito) {
        resp = "S";
        response.sendRedirect("../consultarNot.jsp");
    } else {
        resp = "N";
        response.sendRedirect("../actnoticias.jsp");
    }
%>
<%= resp%>

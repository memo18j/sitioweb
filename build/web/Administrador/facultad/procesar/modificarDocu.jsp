<%-- 
    Document   : modificarDocu
    Created on : 15/06/2017, 06:35:02 AM
    Author     : HP
--%>
...
<%
    ...
    boolean exito = fachada.actualizarDatosDocumento(codigo, nombre, url_imagen);
    System.out.println(exito);
    String resp = "";
    if (exito) {
        resp = "S";
        response.sendRedirect("../consultarDocu.jsp");
    } else {
        response.sendRedirect("../actdocumento.jsp");
    }
%>
<%= resp%>

<%-- 
    Document   : regeventos
    Created on : 7/06/2017, 07:32:19 AM
    Author     : HP
--%>
...
<div class="container">
            ...
            <div class="row">
                <div class="col-md-10">
                    <h1 class="pull-left" style="font-size: 36px;">
                        <b>Informacion de los Eventos</b></h1>
                </div>
                <div class="col-md-2">
    ...
    <div class="container content profile">
        <div class="row">
            ...
            <div>
                <form action="procesar/registrarev.jsp" enctype="multipart/form-data" method="post">
                    <div class="col-md-3"></div>
                    <div class="col-md-6">
                        <div>
                            <div class="headline margin-bottom-30"><h4>Codigo</h4></div>
                            <input type="text" class="form-control" id="cod_eve" name="cod_eve" placeholder="codigo evento">
                        </div>
                        <div>
                            <div class="headline margin-bottom-30"><h4>Nombre Noticia</h4></div>
                            <input type="text" class="form-control" id="nom_eve" name="nom_eve" placeholder="nombre evento">
                        </div>
                        <div>
                            <div class="headline margin-bottom-30"><h4>Descripcion</h4></div>
                            <textarea cols=76 rows=10 name="desc" id="desc"></textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" class="form-control" name="fecha" id="fecha" placeholder="fecha del evento">
                        </div>

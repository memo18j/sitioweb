<%-- 
    Document   : regnoticias
    Created on : 7/06/2017, 07:31:39 AM
    Author     : HP
--%>
...
<div class="container">
    ...
    <div class="container content profile">
        <div class="row">
            ...
            <div>
                <form action="procesar/registrarn.jsp" enctype="multipart/form-data" method="post">
                    <div class="col-md-3"></div>
                    <div class="col-md-6">
                        <div>
                            <div class="headline margin-bottom-30"><h4>Codigo</h4></div>
                            <input type="text" class="form-control" id="cod_not" name="cod_not" placeholder="codigo noticia">
                        </div>
                        <div>
                            <div class="headline margin-bottom-30"><h4>Nombre Noticia</h4></div>
                            <input type="text" class="form-control" id="nom_not" name="nom_not" placeholder="nombre noticia">
                        </div>
                        <div>

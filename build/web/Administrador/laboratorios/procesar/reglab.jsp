<%-- 
    Document   : reglab
    Created on : 4/05/2017, 09:42:10 AM
    Author     : HP
--%>
...
<%
    ...
    boolean exito = fachada.registrarLaboratorio(codigo, nombre, descripcion, url_imagen);

    String resp = "";
    if (exito) {
        resp = "S";
        response.sendRedirect("../reglaboratorios.jsp");
    } else {
        resp = "N";
    }
%>

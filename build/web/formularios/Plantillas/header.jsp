                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-4 col-xs-5">
                                    <a href="https://ww2.ufps.edu.co">
                                        <img id="logo-header"
                                             src="../imagenes/logofaufps.png" alt="Logo UFPS">
                                    </a>
                                </div>
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li class=""><a href="../facultad/mision.jsp">Mision</a></li>
                                    <li class=""><a href="../facultad/vision.jsp">Vision</a></li>
                                    <li class=""><a href="../facultad/Objetivos.jsp">Objetivos</a></li>
                                    <li class=""><a href="../facultad/EstructuraOrganizacional.jsp">Estructura organizacional</a></li>                                         
                                    <li class=""><a href="../facultad/ConcejoFacultad.jsp">Consejo Facultad</a></li>
                                    <li class=""><a href="../facultad/historia.jsp">Historia</a></li>
                                    
                                    <li class=""><a href="../facultad/Documentos.jsp">Documentos</a></li>  
                                </ul>
                            </li>
                            <!-- End Home -->
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="dropdown-submenu">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="../programa/ingsistemas.jsp"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Ingeniería de Sistemas <img id="logo-sello" style="width: 65px; height: 14px;" src="https://ww2.ufps.edu.co/assets/img/icons/sello_acreditada.png" alt="Logo Acreditada"></a></li>
                                            <li><a href="../programa/ingelectronica.jsp"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Ingenieria de Electronica</a></li>
                                            <li><a href="../programa/ingcivil.jsp"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Ingenieria de Civil</a></li>
                                            <li><a href="../programa/ingelectromecanica.jsp"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Ingenieria de Electromecanica</a></li>
                                            <li><a href="../programa/ingmecanica.jsp"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Ingenieria de Mecanica</a></li>
                                            <li><a href="../programa/ingminas.jsp"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Ingenieria de Minas</a></li>
                                            <li><a href="../programa/ingindustrial.jsp"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Ingenieria de Industrial</a></li>
                                        </ul>
                                    </li>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li class=""><a href="../departamentos/departamentos.jsp">Departamentos</a></li>
                                    <li class=""><a href="../departamentos/Docentes.jsp">Docentes</a></li>                                     
                                </ul>
                            </li>
                        <li class="dropdown">
                            <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li class=""><a href="../investigacion/grupos.jsp">Grupos de Investigacion</a></li>

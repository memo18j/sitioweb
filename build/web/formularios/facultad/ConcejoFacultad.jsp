<%-- 
    Document   : ConcejoFacultad
    Created on : 28/04/2017, 09:43:58 AM
    Author     : HP
--%>
    ...
    <div class="container content profile">
        <div class="row">
            ...
            <%
                    ...
                    ArrayList<ConsejoFacultadDTO> dp = fachada.mostrarConsejo();
                    for ( ConsejoFacultadDTO es : dp) {
                %>
            <div class="col-md-8 mb-margin-bottom-30">
                <small class="pull-right" style="color:#aa1916;"><i
                        class="fa fa-calendar"></i></small>
                <div class="margin-bottom-40">
                    <div class="headline margin-bottom-30"><h1>Concejo Facultad</h1></div>
                </div>
                <div>

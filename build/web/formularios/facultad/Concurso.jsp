<%-- 
    Document   : Concurso
    Created on : 28/04/2017, 09:45:18 AM
    Author     : HP
--%>
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="shadow-wrapper">        
                    ...
                    <ul class="nav nav-pills nav-stacked list-group sidebar-nav-v1" id="sidebar-nav">
                        ...
                        <li class="list-group-item" style="border:none; border-bottom: 1px solid #DDDEDF;"><a href="EstructuraInstitucional.jsp" class="text-menu"><i class="fa fa-chevron-circle-right" aria-hidden="true"></i> Estructura organizacional</a></li>
                        ...
                        <li class="list-group-item" style="border:none; border-bottom: 1px solid #DDDEDF;"><a href="Reclamos.jsp" class="text-menu"><i class="fa fa-chevron-circle-right" aria-hidden="true"></i> Quejas y Reclamos</a></li>

                        <li class="list-group-item" style="border:none; border-bottom: 1px solid #DDDEDF;"><a href="Concurso.jsp" class="text-menu"><i class="fa fa-chevron-circle-right" aria-hidden="true"></i> Concursos</a></li>
            ...
            <div class="col-md-8 mb-margin-bottom-30">
                ...
                <div class="margin-bottom-40">
                    ...
                    <div class="headline margin-bottom-30"><h1>Concursos</h1></div>
                </div>
            </div>
        </div>

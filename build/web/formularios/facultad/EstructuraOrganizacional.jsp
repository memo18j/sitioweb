<%-- 
    Document   : EstructuraInstitucional
    Created on : 28/04/2017, 09:43:38 AM
    Author     : HP
--%>
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <%
                    ...
                    ArrayList<EstructuraOrgDTO> dp = fachada.mostrarEstructura();
                    for (EstructuraOrgDTO es : dp) {
                %>
            </div><!--/col-md-3-->
            <div class="col-md-8 mb-margin-bottom-30">
                ...
                <div class="margin-bottom-40">
                    <div class="headline margin-bottom-30"><h1>Estructura Organizacional</h1></div>
                </div>
                <div>
                ...
                <br>
                <div align="center">
                <h5><img id="zoom_01" width="600" height="500" src="<%= es.getLinkimg()%>" data-zoom-image="<%= es.getLinkimg()%>"/></h5>
                </div>
                    <%}%>
            </div>
        </div>
